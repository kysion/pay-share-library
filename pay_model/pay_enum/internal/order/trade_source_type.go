...
var TradeSourceType = tradeSourceType{
    Weixin:   enum.New[TradeSourceTypeEnum](1, "微信"),
    Alipay:   enum.New[TradeSourceTypeEnum](2, "支付宝"),
...
func (e tradeSourceType) New(code int, description string) TradeSourceTypeEnum {
    if (code&TradeSourceType.Weixin.Code()) == TradeSourceType.Weixin.Code() ||
        (code&TradeSourceType.Alipay.Code()) == TradeSourceType.Alipay.Code() ||
