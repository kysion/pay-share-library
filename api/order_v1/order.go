...
type QueryOrderListReq struct {
    g.Meta `path:"/queryOrderList" method:"post" summary:"查询订单列表|信息" tags:"订单"`
    base_model.SearchParams
}

type QueryOrderByAMonthReq struct {
    g.Meta `path:"/queryOrderByAMonth" method:"post" summary:"查询最近一个月的订单|信息" tags:"订单"`
}
